document.addEventListener("DOMContentLoaded", () => {
    ...
    // ! COLOR SHEMA ! //
    const colorScheme = ["#67001f", "#b2182b", "#d6604d", "#f4a582", "#fddbc7", "#f7f7f7", "#d1e5f0", "#92c5de", "#4393c3", "#2166ac", "#053061"];
    ...
    const fetchData = async () => {
        ...
        const cells = heatMapSVG
            ...
            .on("mouseover", (event, d) => {
                var newDate = new Date(d.year, d.month);
                tooltip
                    .style("opacity", 1)
                    .style("translate", `${xScale(d.year)}px ${yScale(d.month)}px`)
                    .attr("data-year", d.year);
                document.querySelector(".date_tip").textContent = d3.utcFormat("%Y - %B")(newDate);
                document.querySelector(".temp_tip").textContent = d3.format(".1f")(baseTemperature + d.variance);
                document.querySelector(".var_tip").textContent = d3.format("+.1f")(d.variance);
            })
            .on("mouseout", () => {
